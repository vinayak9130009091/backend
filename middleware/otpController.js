...
const generateOTP = require("./randomStringGenerator");
const sendEmail = require("./emailService");
const OTP = require("./otpModel"); // Import the OTP model
const OTPModel = require("../middleware/otpModel");
...
<body>
  ...
  try {
    ...
    if (existingOTPRecord) {
      ...
      const updatedOTPRecord = await OTPModel.findOneAndUpdate({ email: email }, { $set: { otp: otp } }, { new: true, upsert: true });
